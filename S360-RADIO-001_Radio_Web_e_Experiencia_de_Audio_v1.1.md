...
# 8.1 Registro técnico obrigatório dos dois assets da Rádio Web

Para evitar qualquer ambiguidade entre o ícone utilizado dentro do Servo360 e o ícone utilizado como acesso externo/PWA, ficam definidos **dois assets distintos e não intercambiáveis**.

| Uso | Asset oficial | Arquivo | Pasta de destino |
|---|---|---|---|
| Menu inferior público | `s360-icon-web-radio` | `web-radio.webp` | `public/assets/servo360/icons/content/` |
| Atalho externo / PWA | `s360-icon-web-radio-app` | `web-radio-app.webp` | `public/assets/servo360/icons/app/` |

## A. Asset do menu inferior

```text
Asset: s360-icon-web-radio
Arquivo: web-radio.webp
Destino: public/assets/servo360/icons/content/web-radio.webp
```
...
Este asset é destinado à **navegação interna pública do Servo360**. Não deve ser utilizado como ícone principal do atalho instalável/PWA.

## B. Asset do atalho externo / PWA

```text
Asset: s360-icon-web-radio-app
Arquivo: web-radio-app.webp
Destino: public/assets/servo360/icons/app/web-radio-app.webp
```

Este asset representa a **Rádio Web como acesso direto instalado/adicionado à tela inicial** do celular, tablet ou desktop.

A partir do asset-base poderão ser produzidas as variantes técnicas necessárias ao PWA:

```text
public/assets/servo360/icons/app/
├── web-radio-app.webp
├── web-radio-app-192.png
├── web-radio-app-512.png
└── web-radio-app-maskable-512.png
```

## Regra de implementação

> **`web-radio.webp` = menu interno. `web-radio-app.webp` = atalho externo/PWA. Não trocar, renomear ou reutilizar um no lugar do outro.**

O atalho externo deverá continuar recebendo a identificação da igreja ou instituição parceira conforme o tenant, enquanto o ícone interno permanece como elemento de navegação da interface Servo360.
...
**S360-RADIO-001 v1.1 — BASELINE FUNCIONAL E TÉCNICO**
