-- ============================================================
-- FAM019 — RPC transaccional do workflow editorial de banners
--
-- Integra content_workflow_state com public.banners e
-- fam_banner_audit_events. Operação aditiva e não destrutiva.
-- Não altera tokens, classes ou paleta visual FAM.
-- ============================================================
...
comment on function public.transition_fam_banner_workflow(uuid, text, text)
is 'Transição transaccional FAM de banner: sincroniza workflow editorial, visibilidade, timestamps e auditoria.';
