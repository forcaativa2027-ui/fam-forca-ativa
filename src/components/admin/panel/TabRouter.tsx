...
import { OrgTerminologyAdmin } from "../OrgTerminologyAdmin";
...
export function TabContent({ activeTab, onNavigate, prefillEventId }: { activeTab: TabKey; onNavigate: (tab: TabKey) => void; prefillEventId?: string | null }) {
  ...
  switch (activeTab) {
    ...
    case "kids-admin":          return <KidsAdmin />;
    case "org-terminology":     return <OrgTerminologyAdmin />;
    ...
    case "fam-conhecimento": return <TenantModuleGuard moduleKey="knowledge_journey" title="Jornada do Conhecimento indisponível" description="A Jornada do Conhecimento não está activa para esta organização."><FamKnowledgeAdmin /></TenantModuleGuard>;
