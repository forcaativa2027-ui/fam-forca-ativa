...
import { AlertTriangle, ArrowLeft, CheckCircle2, MessageCircle, Phone, ShieldAlert, Send, X } from "lucide-react";
...
export function FamRiskAnalysisPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 py-6">
      <Button onClick={() => router.back()} variant="outline" size="sm" className="gap-1.5" aria-label="Voltar à página anterior">
