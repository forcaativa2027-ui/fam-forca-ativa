    ...
    <main className="relative grid min-h-screen place-items-center bg-[radial-gradient(circle_at_30%_20%,#6B214F,#3A1236_65%)] p-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-2xl">
        <div className="flex items-center gap-2">
          <Sparkles className="h-5 w-5 text-fam-gold" />
          <h1 className="font-display text-2xl text-fam-plum">Área privada FAM</h1>
        </div>
        <div className="my-3 h-[3px] w-16 rounded bg-fam-gold" />
        <p className="mb-6 text-xs text-muted-foreground">Atendimento, projetos, comunicação e serviços FAM</p>
        ...
        <div className="mt-3 text-center">
          <Link href="/recuperar-senha" className="text-sm font-semibold text-fam-plum underline underline-offset-2 hover:text-fam-gold transition-colors">
            Esqueceu a senha?
          </Link>
        </div>
        <div className="mt-5 border-t border-gray-200 pt-5 text-center space-y-2">
          ...
          <Link href="/cadastrar">
            <Button type="button" variant="outline" className="w-full border-fam-plum text-fam-plum hover:bg-fam-plum hover:text-white transition-colors">
