 ...
 * - Verifica se quem chama é admin (administrador FAM) usando o access_token enviado
...
export async function POST(req: Request) {
  ...
  // 1) Verifica autor da requisição: precisa ser administrador FAM
  ...
  if (!callerProfile || !["adm_general", "adm_instituicao"].includes(callerProfile.role)) {
