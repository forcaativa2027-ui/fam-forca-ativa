 ...
 *
 * Só quem já é Administrador Geral pode chamar essa rota. A ação fica registrada
 * na auditoria.
 */
export async function POST(req: Request) {
  ...
  if (!callerProfile || callerProfile.role !== "adm_general") {
    return NextResponse.json({ error: "Apenas o Administrador Geral pode redefinir o 2FA de outra pessoa." }, { status: 403 });
  }
