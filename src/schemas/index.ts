...
export const memberSchema = z.object({
  ...
  journey_stage: z.enum(["visitante","novo_convertido","consolidacao","discipulado","batismo","membro_ativo","membro_efetivo","servo","lider_formacao","lider","diacono","supervisor","supervisor_setor","supervisor_area","supervisor_distrito","pastor_auxiliar","pastor_principal","missionario"]).default("visitante"),
});
...
export const memberFullEditSchema = z.object({
  ...
  journey_stage: z.enum(["visitante","novo_convertido","consolidacao","discipulado","batismo","membro_ativo","membro_efetivo","servo","lider_formacao","lider","diacono","supervisor","supervisor_setor","supervisor_area","supervisor_distrito","pastor_auxiliar","pastor_principal","missionario"]),
